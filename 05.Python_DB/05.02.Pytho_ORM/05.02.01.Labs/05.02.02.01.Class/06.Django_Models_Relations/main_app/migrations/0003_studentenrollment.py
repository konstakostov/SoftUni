# Generated by Django 4.2.4 on 2023-11-12 10:20
...
class Migration(migrations.Migration):
    ...
    # Next, in the operations list, we add a specialized operation called SeparateDatabaseAndState which allows us to
    # alter the state and the database separately. In this specialized operation, we will add the above-written state
    # operations.
    operations = [
        ...
        # Finally, we reset the name (which is set to main_app_student_subjects above) to use the default naming
        # convention
        migrations.AlterModelTable(
            name='studentenrollment',
            table=None,
