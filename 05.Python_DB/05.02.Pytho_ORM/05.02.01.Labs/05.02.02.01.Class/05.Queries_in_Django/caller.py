...
def add_records_to_database():
    ...
    books = [
        Book(
            ...
            author="John Smith", publication_year=2010,
            genre="Mystery",
            language="English",
            page_count=320
        ),
        ...
        Book(
            title="Fantasy World: The Quest Begins",
            author="Jane Johnson",
    ...
    reviews = [
        Review(
            ...
            book_title="The Mystery of the Lost Key",
        ...
        Review(
            ...
            book_title="Fantasy World: The Quest Begins",
...
# # Filter Authors by Nationalities
