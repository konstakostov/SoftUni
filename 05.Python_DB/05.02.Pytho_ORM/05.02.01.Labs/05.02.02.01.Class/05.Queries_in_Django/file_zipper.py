...
def zip_current_level(exclude_list, zip_name="django_zip_submit.zip"):
    """
...
if __name__ == "__main__":
    ...
    exclude_list = ["venv", ".idea", "templates", "__pycache__",
                    "file_zipper.py", "populate_model_with_data.py",
                    ]
