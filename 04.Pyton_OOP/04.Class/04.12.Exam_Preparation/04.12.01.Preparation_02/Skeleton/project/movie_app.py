...
class MovieApp:
    ...
    # ADDITIONAL METHOD
    def get_register_user(self, username) -> User or None:
    ...
    # ADDITIONAL METHOD
    def get_movie(self, title) -> Movie or None:
        existing_movie = [m for m in self.movies_collection if m.title == title.title]
        if existing_movie:
    ...
    def register_user(self, username: str, age: int):
        existing_user = self.get_register_user(username)
        if existing_user:
