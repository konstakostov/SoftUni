...
class Library:
    def __init__(self):
        self.user_records: List[str] = []       # [User_01, User_02, ...]
        self.books_available: Dict[str: List[str]] = {}     # {"Author": [Book_01, Book_02]}
        self.rented_books: Dict[str: Dict[str: int]] = {}   # {"Usernames": {"Book": Days_Left_Return}}
